...
%\figi{infrastructure-dev-db-docker.drawio}{16cm}{Infrastructure de développement avec une DB end docker}
...
%\figi{infrastructure-dev-homestead.drawio}{16cm}{Infrastructure de développement avec Laravel Homestead}

%\fig{infrastructure-dev-db-laravel-vuejs-docker.drawio}{Infrastructure de développement avec une DB, Laravel et Vue.js en docker}
