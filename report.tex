...
%virtual machine vs containers: https://www.youtube.com/watch?v=cjXI-yxqGTI
...
\subsection{Performances de \Gls{docker}}
...
%todo ajouter figure
Fig. 3. Network round-trip latency (µs)
...
\subsubsection{Et les Linux Containers?}
Pourquoi utiliserions-nous forcément \Gls{docker} sans avoir réfléchi à la possibilité de Kubernetes?
%https://linuxcontainers.org/

% dev
\subsection{Infrastructures de développement}

%https://stackshare.io/stackups/docker-vs-laravel-homestead
...
\begin{itemize}
    ...
    \item Configuration en gande partie déjà réalisée,
    \item Compatible avec tous les OS,
    \item Existance d'un outil conçu pour être utiliser avec \Gls{docker} (sail)
    \item Permet d'avoir plusieurs versions installées.
\end{itemize}
...
\subsubsection{Analyse de risque}
...
% pour le déploiment, regarder pourquoi certains sont parti de docker

% devops
%https://blog.logrocket.com/how-to-create-a-ci-cd-for-a-laravel-application-using-github-actions/

\subsection{\Gls{devops}}
Mais qu'est-ce que c'est les DevOps:
...
Dans tous les exemples ci-dessus, l'outil utilisé pour réaliser les \Gls{devops} est Github, mais pourquoi?
Tout d'abord, il faut comprendre qu'il existe d'autres outil de "gestion" de \Gls{devops}, appelé aussi services de \Gls{ci} / \Gls{devops}, voici une liste non exhaustive:
\begin{itemize}
...
Nous cherchons une solution "all in one" pour simplifier au maximum le projet au niveau des \Gls{devops}.
Nous n'allons donc pas plonger dans les détails de chaque technologie cité plus haut.
Il reste donc GitLab et Github, pour effectuer notre choix.
% choix entre github et gitlab, ma décision
