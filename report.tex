...
Tout d'abord, il faut comprendre qu'il existe d'autres outil de "gestion" de \Gls{devops}, des services de CI ou Devops, voici une liste non exhaustive:
\begin{itemize}
...
Tous ces outils, mise à part GitLab, doivent être installé et configurer pour le projet.
...
% à rendre aussi pour le premier rendu
% model de l'ORM
