...
\figi{infrastructure_dev_actuelle.drawio}{16cm}{Infrastructure de développement actuelle}

%\figi{infrastructure_dev_db_docker.drawio}{16cm}{Infrastructure de développement avec une db end docker}
%\fig{infrastructure_dev_db_docker}{Infrastructure de développement avec une db end docker}
%\fig{infrastructure_dev_db_docker.drawio}{Infrastructure de développement avec une db end docker}

%\figi{infrastructure_dev_db_laravel_docker.drawio}{16cm}{Infrastructure de développement avec une db et Laravel en docker}
%\fig{infrastructure_dev_db_laravel_docker.drawio}{Infrastructure de développement avec une db et laravel en docker}
...
%\figi{infrastructure_dev_db_laravel_homestead.drawio}{16cm}{Infrastructure de développement avec Laravel Homestead}

%\figi{infrastructure_dev_db_laravel_vuejs_docker.drawio}{16cm}{Infrastructure de développement avec une db, Laravel et Vue.js en docker}
...
En résumé, tous les outils ont été installés nativement sur la machine de développement sans virtualisation.
%\figi{infrastructure_prod_actuelle.drawio}{16cm}{Infrastructure de production actuelle}
%\fig{infrastructure_prod_actuelle.drawio}{Infrastructure de production actuelle}

Cette figure-ci, montre la première amélioration possible, c'est à dire, de passer le SGBD en container docker.
%\figi{infrastructure_prod_db_docker.drawio}{16cm}{Infrastructure de production avec une db en docker}
%\fig{infrastructure_prod_db_docker.drawio}{Infrastructure de production avec une db en docker}
...
%\figi{infrastructure_prod_db_laravel_docker.drawio}{16cm}{Infrastructure de production avec une db et laravel en docker}
%\fig{infrastructure_prod_db_laravel_docker.drawio}{Infrastructure de production avec une db et laravel en docker}
...
%\figi{devops_dockerhub.drawio}{16cm}{DevOps via dockerhub}
%\fig{devops_dockerhub.drawio}{DevOps via dockerhub}
...
%\figi{devops_heroku.drawio}{16cm}{DevOps via heroku}
%\fig{devops_heroku.drawio}{DevOps via heroku}
...
%\figi{devops_github.drawio}{16cm}{DevOps via github}
%\fig{devops_github.drawio}{DevOps via github}
...
\figi{architecture_code_spring.drawio}{16cm}{Architecture de code du framework Spring "classique"}
%\fig{architecture_code_spring.drawio}{Architecture de code du framework Spring "classique"}

\figi{architecture_code_laravel.drawio}{16cm}{Architecture de code du framework Laravel "classique"}
%\fig{architecture_code_laravel.drawio}{Architecture de code du framework Laravel "classique"}

\figi{architecture_code_laravel_proposee.drawio}{16cm}{Architecture de code Laravel proposée}
%\fig{architecture_code_laravel_proposee.drawio}{Architecture de code Laravel proposée}
