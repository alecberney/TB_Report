...
\fig{stack-old-tb}{Stack de technologies utilisées dans l'ancien travail }%\label{stack-old-tb}}
...
Commençant par la latence que peut apporter Docker: %\ref{}
...
Le principal problème de ces solutions est le manque de popularité comme on peut le remarquer sur la figure %\ref{}

%\figi{google-trend-containers-2022.png}{16cm}{Tendances sur les différentes solutions de conteneurs depuis 2004}
...
\figi[Infra. avec une DB en Docker]{infrastructure-dev-db-docker.drawio}{16cm}{Infrastructure de développement avec une DB en Docker}
...
\figi[Infra. de dev avec DB + Laravel + Vue en Docker]{infrastructure-dev-db-laravel-vuejs-docker.drawio}{16cm}{Infrastructure de développement avec une DB, Laravel et Vue.js en Docker}
...
\begin{multicols}{2}[Nous recommençons également par réfléchir sur le passage du SGBD en machine Docker.]
    ...
    \begin{itemize}
        ...
        \item Mise en place d'un service de façon triviale,
        \item Le SGBD peut-être déjà installé et peut être utilisée directement,
        \item Ne nécessite pas Docker.
    \end{itemize}
...
\begin{table}[h]
    \begin{center}
        \caption{Environement de développment choisi \label{env-prod}}
        \begin{tabular}{c|l|r}
            Outil             & Technologie utilisée \\ \hline
            SGBD - MySQL      & Docker               \\
